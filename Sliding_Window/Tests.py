...
import Sliding_Window.solutions_two as sliding_window_two
...
class SolutionsTest(unittest.TestCase):
    ...
    def test_min_window(self):
        ...
        t = "ABC"
        output = "BANC"
        self.assertEqual(sliding_window_two.min_window(s, t), output)
        s = "a"
        t = "a"
        output = "a"
        self.assertEqual(sliding_window_two.min_window(s, t), output)
    ...
    def test_longest_ones(self):
        ...
        k = 2
        output = 6
        self.assertEqual(sliding_window_two.longest_ones(nums, k), output)
    ...
    def test_max_satisfied(self):
        ...
        minutes = 3
        output = 16
        self.assertEqual(sliding_window_two.max_satisfied(customers, grumpy, minutes), output)
        customers = [1]
        grumpy = [0]
        minutes = 1
        output = 1
