...
from TakeOne import Graph as graph_two, Graph as graph_three, Graph as graph_four, Graph as graph_six, \
    Graph as graph_seven
import TakeOne.Graph.Solution_Five as graph_five
...
class SolutionsTest(unittest.TestCase):
    def test_find_town_judge(self):
        ...
        trust = [[1, 2]]
        output = 2
        self.assertEqual(output, graph_six.find_town_judge(n, trust))
        n = 3
        trust = [[1, 3], [2, 3]]
        output = 3
        self.assertEqual(output, graph_six.find_town_judge(n, trust))
    ...
    def test_minimum_vertices_reach_all_nodes(self):
        ...
        output = [0, 3]
        self.assertListEqual(output, graph_six.minimum_vertices_reach_all_nodes(n, edges))
        n = 5
    ...
    def test_keys_and_rooms(self):
        rooms = [[1], [2], [3], []]
        output = True
        self.assertEqual(output, graph_six.keys_and_rooms(rooms))
        rooms = [[1, 3], [3, 0, 1], [2], [0]]
        output = False
        self.assertEqual(output, graph_six.keys_and_rooms(rooms))
